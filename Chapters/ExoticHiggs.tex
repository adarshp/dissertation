...
\begin{marginfigure}
\centering
\caption{Feynman diagrams for charged Higgs production in association with a heavy quark.)}%
\subbottom[\emph{t}-channel]{\resizebox{\textwidth}{!}{
\feynmandiagram [layered layout, vertical = g1  to g2] { 
% Draw the top and bottom lines 
g1	-- [gluon] a 
	-- [fermion] t [particle=\(t\)],
    { [same layer] a -- [opacity = 0.0] c},  
                     % --c},
    a --[anti fermion, edge label = \(\overline{t}^*\)] v, v --  [anti fermion, edge label' = \(\overline{b}^*\)] c,
    v -- [scalar] h [particle = \(H^-\)],
g2 -- [gluon] c 
   -- [anti fermion] b [particle=\(\overline{b}\)],
% Draw the two internal fermion lines 
};
 }}
 \subbottom[\emph{s}-channel]{\resizebox{\textwidth}{!}{
\feynmandiagram [layered layout, horizontal=v1 to v2] { 
  g1 -- [gluon] v1 -- [fermion, edge label=\(b^*\)] v2 -- [fermion] t [particle = \(t\)],
  g2 -- [gluon] v3,
  {[same layer] v3 -- [fermion, edge label = \(t\)] v1},
  v3 -- [anti fermion] b [particle = \(\overline{b}\)] ,
  v2 -- [scalar] h [particle= \(H^-\)],
};
}}
\subbottom[$t\overline{t}$-like]{\resizebox{\textwidth}{!}{
\feynmandiagram [horizontal = v1 to v2] { 
  {g1 , g2 } -- [gluon] v1 -- [gluon] v2,
  t [particle = \(\overline{t}\)]-- [fermion] v2 -- [fermion, edge label = \(t^*\)] tb,
  hc [particle = \(H^+\)]-- [scalar] tb -- [fermion] b [particle = \(b\)],
};
}}
