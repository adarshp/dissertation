...
\section{The $2$HDM scalar potential}
...
\section{The $2$HDM mass spectrum}
...
\begin{table}
  \[
    \begin{array}{lrrrr}
      ...
      \bottomrule
\end{array}\]
\caption{List of the factors $\xi$ that determine the Yukawa couplings of the $2$HDM Higgs bosons.}
...
\end{equation}
Thus the couplings of \emph{h} and \emph{H} become rescaled versions of Standard Model Higgs couplings to the vector bosons. If we represent these couplings by $g_{h_\text{SM}VV}$, where $VV$ can be $ZZ$ or $W^+W^-$, then the Yukawa couplings of the $2$HDM Higgses are given by
\begin{align}
